...
<body>
    <center>
    <div style="background: rgb(255, 146, 127);">
        <h1>Datos del Empleado:</h1>
    </div>
    
    <div style="background: blueviolet; border:solid 2px" class="container">
        <h2>N°:</h2>
        <input type="text" name="nombre" value="{{ $relevamientos -> id}}">
        <h2>Empleado:</h2>
