...
<body>
  ...
  <div class="header_section">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-3">
          <div class="logo"><a href="welcome"><img src="/public/images/logo.png"></a></div>
        </div>
        <div class="col-md-9">
          <div class="menu_text">
            <ul>
              <div class="togle_3">
                <div class="menu_main">
                  <div class="padding_left0"><a href="#">Registrarse</a>
                    <span class="padding_left0"><a href="#">Iniciar sesión</a></span>
                  </div>
                </div>
                <div class="shoping_bag" img src="{{ asset('images/img-7.pnggit ')}}"></div>
              </div>
              <div id="myNav" class="overlay">
                <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
                <div class="overlay-content">
                  <a href="resources/views/welcome">Home</a>
              ...
              <span onclick="openNav()" img src="{{ asset('images/perro.jpg')}}" class="toggle_menu"></span>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-sm-5">
            ...
            <div class="contact_bt"><a href="contact.html">CONTACT US<span class="contact_padding"><img
                    src="public/images/contact-icon.png"></span></a></div>
          </div>
          <div class="col-sm-2">
            <div class="play_icon"><a href="#"><img src="public/images/play-icon.png"></a></div>
          </div>
          <div class="col-sm-5">
            <div><img src="public/images/img-1.png" class="image_1"></div>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="services_section layout_padding">
    <div class="container">
      <h1 class="services_taital"><span>Our</span> <img src="public/images/icon-1.png"> <span
  ...
  <div class="about_section layout_padding">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div><img src="public/images/img-2.png" class="image_2"></div>
        </div>
        <div class="col-md-6">
          <h1 class="services_taital"><span>About </span> <img src="public/images/icon-1.png"> <span
          ...
          <div class="contact_bt_1"><a href="#">READ MORE<span class="contact_padding"><img
                  src="public/images/contact-icon1.png"></span></a></div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="choose_section layout_padding">
    <div class="container">
      <h1 class="choose_taital"><span>Why </span> <img src="public/images/icon-1.png"> <span style="color: #1f1f1f">Choose
          Us</span></h1>
      ...
      <div class="choose_section_2 layout_padding">
        ...
        <div class="image_3"><img src="public/images/img-3.png"></div>
  ...
  <div class="team_section layout_padding">
    <div class="container">
      <h1 class="choose_taital"><span>Our </span> <img src="public/images/icon-1.png"> <span style="color: #1f1f1f">Team</span>
      </h1>
      <p class="choose_text">Consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna
        aliqua</p>
      <div class="team_section_2 layout_padding">
        <div class="container">
          <div class="images_main_1">
            <div class="row">
              <div class="col-sm-5">
                <div class="image_4"><img src="public/images/img-4.png"></div>
                ...
                <div class="follow_social_icon">
                  <ul>
                    ...
                    <li><a href="#"><img src="public/images/linkden-icon.png"></a></li>
          ...
          <div class="images_main">
            <div class="row">
              ...
              <div class="col-sm-5">
                <div class="image_4"><img src="public/images/img-5.png"></div>
                <h6 class="follow_text">Follow Us</h6>
                <div class="follow_social_icon">
                  <ul>
                    <li><a href="#"><img src="public/images/fb-icon.png"></a></li>
          ...
          <div class="images_main_1">
            <div class="row">
              <div class="col-sm-5">
                <div class="image_4"><img src="public/images/img-6.png"></div>
                <h6 class="follow_text">Follow Us</h6>
                <div class="follow_social_icon">
                  <ul>
                    <li><a href="#"><img src="public/images/fb-icon.png"></a></li>
          ...
          <div class="images_main">
            <div class="row">
              ...
              <div class="col-sm-5">
                <div class="image_4"><img src="public/images/img-7.png"></div>
                <h6 class="follow_text">Follow Us</h6>
                <div class="follow_social_icon">
                  <ul>
                    <li><a href="#"><img src="public/images/fb-icon.png"></a></li>
    ...
    <div class="container">
      <div class="footer_main">
        <div class="footer_left">
          <h1 class="contact_taital"><span>Contact </span> <img src="public/images/icon-2.png"> <span>Us</span></h1>
        </div>
        <div class="footer_left">
          <div class="location_text"><a href="#"><img src="public/images/map-icon.png"><span
                class="padding_left_15">Locations</span></a></div>
        </div>
        <div class="footer_left">
          <div class="location_text"><a href="#"><img src="public/images/call-icon.png"><span class="padding_left_15">+71
          ...
          <div class="col-md-6">
            ...
            <div class="social_icon">
              <ul>
                ...
                <li><a href="#"><img src="public/images/twitter-icon1.png"></a></li>
                <li><a href="#"><img src="public/images/linkden-icon1.png"></a></li>
                <li><a href="#"><img src="public/images/instagram-icon1.png"></a></li>
              </ul>
            </div>
          </div>
        </div>
